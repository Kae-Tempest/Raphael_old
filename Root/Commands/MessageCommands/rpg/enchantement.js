...
module.exports = {
	...
	run: async (client, message) => {
		...
		const SelectItem = new MessageActionRow().addComponents(new MessageSelectMenu().setCustomId('enchantementselectitem').setPlaceholder('Choose one Item').addOptions(itemList));
		message.reply({
